...
int main(int argc, char** argv) {
  ...
  try {
    ...
    std::cout << "WARNING AE: This example will move the robot! "
    ...
    /*
     * AE: my attempt to move the elobow to a new place
     */
     // First move the robot to a suitable joint configuration
     std::array<double, 7> q_goal2 = {{0, M_PI_2, 0, 3 * M_PI_4, 0, -M_PI_2, -M_PI_4}};
     MotionGenerator motion_generator2(0.5, q_goal2);
